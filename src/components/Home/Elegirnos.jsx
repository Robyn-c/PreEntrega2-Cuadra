...
export const Elegirnos = () => {
  return (
    <Box bgColor='purple.800'>
      ...
      <SimpleGrid templateColumns='repeat(3, auto)' justifyContent='space-between' columnGap='24px'>
          <Stack borderRadius={8} p={7} bgColor='white' align='center' spacing='16px'> 
            <Image boxSize='120px' src={mano}></Image>
          ...
          <Stack borderRadius={8} p={7} bgColor='white' align='center' spacing='16px'> 
            <Image boxSize='120px' src={camion}></Image>
          ...
          <Stack borderRadius={8} p={7} bgColor='white' align='center' spacing='16px'> 
            <Image boxSize='120px' src={diamante}></Image>
